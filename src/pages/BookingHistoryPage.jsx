...
import { FaMapMarkerAlt, FaCalendar, FaCar, FaReceipt, FaTimes } from 'react-icons/fa';
...
const BookingHistoryPage = () => {
  ...
  const mockBookings = [
    ...
    },
    {
      ...
      address: 'Infopark Campus, Kakkanad, Kochi',
        ...
        <Container>
          ...
          <Row className="mb-4">
            <Col>
              ...
              <p className="text-light opacity-75">Manage your parking reservations</p>
            </Col>
          </Row>
            ...
            <Col>
              {filteredBookings.length === 0 ? (
                ...
                filteredBookings.map((booking) => (
                  <Card key={booking.id} className="bg-dark text-light border-secondary mb-3">
                    <Card.Body>
                      <Row className="align-items-center">
                        <Col md={6}>
                          <div className="d-flex align-items-start mb-2">
                            ...
                            <div>
                              <h6 className="fw-bold mb-1">{booking.location}</h6>
                        ...
                        <Col md={3} className="text-center">
                          <div className="mb-2">
                            <Badge bg={getStatusVariant(booking.status)} className="fs-6">
                              {getStatusText(booking.status)}
                            </Badge>
                          </div>
                          <h5 className="text-success fw-bold">₹{booking.totalPrice}</h5>
                          <small className="text-muted">{booking.totalHours} hours</small>
                        </Col>
                        ...
                        <Col md={3}>
                          <div className="d-grid gap-2">
                            ...
                            {booking.status === 'cancelled' && (
                              <Button as={Link} to="/vehicles" variant="outline-success" size="sm">
                                Re-book
                              </Button>
                            )}
                          </div>
